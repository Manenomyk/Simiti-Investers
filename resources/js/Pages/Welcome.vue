    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-blue-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto ">
            <div class="flex justify-start">
                <!-- <h2 class="text-[2rem] font-bold">Simiti Logo</h2> -->
                <!-- <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto bg-gray-100 dark:bg-yellow-900">
            ...
            <div class="back w-full h-screen md:mt-[4rem] fixed z-0">
                qwertyui
            </div>
