    ...
    <div class="">
        ...
        >
            <div class="md:w-[50%] text-center">
                ...
                <div>
                    <h3
                        class="mt-[2rem] mb-[2rem] text-lg font-bold text-green-500"
                    >
                ...
                <div class="flex justify-center gap-2 mt-5">
                    <h5 class="font-bold text-blue-600">
                        Want to explore more <span class="text-white">?</span>
                    </h5>
                    <a href="/register" class="font-bold text-yellow-400"
                        >Join Us for free</a
                    >
                </div>
            </div>
        ...
        <div className="w-full p-[5rem] px-4 bg-white">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                <div className="flex flex-col justify-center">
                    <h1
                        className="text-[#00df9a] uppercase font-bold text-center mt-3"
                    >
                        Everything Optimized just for you
                    </h1>
                    <p
                        className="md:text-2xl sm:text-xl text-lg font-bold py-2"
                    >
                        Find Suppliers with ease
                    </p>
                    <p class="">
                        Let's collaborate to elevate your sourcing strategy and
                        unlock the potential for success. Reach out today to
                        embark on a journey towards unparalleled efficiency and
                        supplier satisfaction. Whether you're targeting specific
                        regions, seeking featured suppliers, or narrowing down
                        by category, We are here to streamline your procurement
                        process.
                        <br />
                        With a keen eye for detail and a dedication to
                        excellence, we ensure that each supplier match is
                        optimized to meet your requirements, saving you time and
                        resources.
                    </p>
                    <button
                ...
                <img
                    className="w-[400px] mx-auto my-3"
                    src="../../Assets/search.jpg"
                    alt="accounting images"
                />
            </div>
        </div>
        ...
        <div className="w-full p-[5rem] px-4 bg-[#144b6e]">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                <img
                    className="w-[550px] mx-auto my-3"
                    src="../../Assets/supplier.png  "
                    alt="accounting images"
                />
                <div className="flex flex-col justify-center">
                    <h1
                        className="text-yellow-400 uppercase font-bold text-center mt-3"
                    >
                        Want to join the Supply list?
                    </h1>
                    <p
                        className="md:text-2xl sm:text-xl text-lg font-bold py-2 text-gray-400"
                    >
                        Make your products known today
                    </p>
                    <p class="text-white">
                        By joining forces with us, you gain access to a dynamic
                        platform that values innovation, quality, and
                        sustainable partnerships. Whether you specialize in
                        construction, or offer unique solutions in material
                        supply, we're excited to explore how your offerings can
            ...
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                <div className="flex flex-col justify-center">
                    ...
                    <p
                        className="md:text-2xl sm:text-xl text-lg font-bold py-2"
                    >
                        Elevate Your Presence with Our Featured Supplier Package
                        today!
                    </p>
                    <p class="">
                        We're excited to announce an exclusive opportunity for
                        you to enhance your visibility and reach within our
                        network. Introducing our Featured Supplier Package - a
                        premium offering designed to spotlight your brand and
                        unlock unparalleled marketing benefits. <br /><br />

                        By upgrading to our Featured Supplier Package, you'll
                        enjoy a host of advantages, including: Prime Placement,
                        Enhanced Visibility, Targeted Marketing, Priority
                ...
                <img
                    className="w-[600px] mx-auto my-3"
                    src="../../Assets/upgrade.jpg"
                    alt="accounting images"
                />
            </div>
        </div>
        ...
        <div class="absolute w-full h-[80vh]">
            ...
            <div class="m-4 absolute top-10">
                ...
                <p class="mt-5 text-white grid md:grid-cols-3">
                    ...
                    building suppliers. Unlock efficiency and quality like never
                    before. Transform your builds with premium materials and
                    expert craftsmanship. Take the next step towards excellence
                    today!"
                </p>
